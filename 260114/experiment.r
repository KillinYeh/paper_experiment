...
save.image(file = "backup_seq_20260201.RData")

sim_cov <- main_simulation(cov_forest_100,cov_test_x)

save.image(file = "backup_seq_20260201_full.RData")
...
#-------------------------experiment----------------------
sim_u_email <- main_simulation(email_forest100,email_test_x)

sim_u_fetal <- main_simulation(fetal_forest100,fetal_x)

sim_u_gene  <- main_simulation(gene_forest100,gene_test_x)

sim_u_mush  <- main_simulation(mush_forest100,mush_test_x)

sim_u_loan  <- main_simulation(loan_forest100,loan_test_x)

sim_u_gesture <- main_simulation(gesture_forest100,gesture_test_x)

sim_u_arcene <- main_simulation(arcene_forest100,arcene_test_x)

sim_u_gas <- main_simulation(gas_forest100,gas_test_x)

save.image(file = "backup_union_20260201.RData")

sim_u_cov <- main_simulation(cov_forest_100,cov_test_x)

save.image(file = "backup_union_full_20260201.RData")
